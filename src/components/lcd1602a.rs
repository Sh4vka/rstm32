...
impl LCD8 {
    pub fn new() -> Self{
        let a0 = Pin::new(Port::PA, 0, TypePin::Output(LogOut::Gpio(IO::PP)));
        let a1 = Pin::new(Port::PA, 1, TypePin::Output(LogOut::Gpio(IO::PP)));
        let a2 = Pin::new(Port::PA, 2, TypePin::Output(LogOut::Gpio(IO::PP)));
        let a3 = Pin::new(Port::PA, 3, TypePin::Output(LogOut::Gpio(IO::PP)));
        let a4 = Pin::new(Port::PA, 4, TypePin::Output(LogOut::Gpio(IO::PP)));
        let a5 = Pin::new(Port::PA, 5, TypePin::Output(LogOut::Gpio(IO::PP)));
        let a6 = Pin::new(Port::PA, 6, TypePin::Output(LogOut::Gpio(IO::PP)));
        let a7 = Pin::new(Port::PA, 7, TypePin::Output(LogOut::Gpio(IO::PP)));

        let b5 = Pin::new(Port::PB, 5, TypePin::Output(LogOut::Gpio(IO::PP)));
        let b6 = Pin::new(Port::PB, 6, TypePin::Output(LogOut::Gpio(IO::PP)));
